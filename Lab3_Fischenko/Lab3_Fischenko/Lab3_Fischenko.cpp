...
int main()
{
	...
	cout<< "Лабораторная работа №3, Фищенко Игорь ИВТ-8, 1(уск) курс\nВыберите номер задания или \'0\' для выхода: ";
	int num = 0;
	cin >> num;
	system("cls");
	while (num != 0) {
		...
		system("pause");
		system("cls");
		cout << "Выберите номер задания (1-2) или \'0\' для выхода: ";
		cin >> num;
	}
	return 0;
}
...
void Task_2() {
	...
	employee[0] = new Photographer("Igor", "Fischenko", 'm', 2001, 2017, "0713311710", 57);
	employee[1] = new Photographer("Den", "Kirkovec", 'm', 2000, 2015, "0716846126", 102);
	employee[2] = new Designer("Julia", "Naxia", 'f', 1999, 2017, "0718625923");
	employee[3] = new Designer("Septerma", "Kadelenc", 'f', 2001, 2019, "0710012314");
